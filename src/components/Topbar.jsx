      ...
      <StyledContainer>
        <FlexBetween width="74%">
          <FlexBox alignItems="center" gap={1}>
            ...
            />
            <Span className="title">Free Returns</Span>
          
          </FlexBox>
          <Span className="title">3 Years Warranty</Span>
          <Span className="title">Competitive Prices</Span>
          <Span className="title">+1-844-228-5319</Span>
            ...
            handler={
              <TouchRipple className="handler marginRight">
                <Span className="menuTitle">
                  {language === "en" ? "Gross Prices" : "Gross Prices"}
                </Span>
